...
check(index.includes("selectWebLiveChannel('crime')") && index.includes("selectWebLiveChannel('docu')") && index.includes("selectWebLiveChannel('cucina')"), 'Selettori Live Web desktop incompleti');
