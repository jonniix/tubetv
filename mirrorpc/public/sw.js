const CACHE='mirrorpc-v7';
const SHELL=['./?app=v7','./display.html','./style.css?v=7','./public-portal.js?v=7','./host.js?v=7','./viewer.js?v=7','./vendor-jsqr.js','./icon.svg','./manifest.webmanifest'];
