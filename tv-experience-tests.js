...
check(index.includes("rewind24:{name:'Rewind 24h'") && mobile.includes("rewind24: {name:'Rewind 24h'") && liveStateApi.includes("'rewind24', 'rewind7', 'rewind30'"), 'Rewind channels are not available on desktop, mobile and API');
